...
class GameInfo(models.Model):
    ...
    imgUrl = models.FileField('主要图片', upload_to='NineCo/static/img/')
    Url = models.FileField(
        '上传APP',  blank=True, null=True, upload_to='NineCo/static/apps/')
    QRimg = models.FileField(
        '上传二维码图片',  blank=True, null=True, upload_to='NineCo/static/img/')
    ...
    imgContent1 = models.FileField(
        '图片介绍1', blank=True, null=True, upload_to='NineCo/static/img/')
    imgContent2 = models.FileField(
        '图片介绍2', blank=True, null=True, upload_to='NineCo/static/img/')
    imgContent3 = models.FileField(
        '图片介绍3', blank=True, null=True, upload_to='NineCo/static/img/')
...
class News(models.Model):
    ...
    upLoadImg = models.FileField(
        '上传新闻中的图片，引用图片请采用"/static/img/xxx.xx"格式', blank=True, null=True, upload_to='NineCo/static/img/')
